...
const ItemListContainer = () => {
    ...
    useEffect (()=> {
        const productos = [
            { "id": 1, "nombre": "Bidon 20 lts", "precio":550, "descripcion": "Bidón retornable de agua x 20 litros", "image": "https://sodayaguastrubolini.com.ar/wp-content/uploads/2017/04/Bidon-retornable-de-agua-x-20-litros.jpg" },
